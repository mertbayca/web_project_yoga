...
const About = () => {
  return (
    <div id="About" className="a_bg">
        ...
        <div className="a_cta">
            <div className="a_cta_text">
                <h4>Download LotusFocus now and embark on your path to inner peace!</h4>
            </div>
            <div className="a_cta_button">
                <a href="https://play.google.com/store/games?hl=us&gl=US"><img src={googleplay} alt="Google Play icon"/>Google Play</a>
                <a href="https://www.apple.com/app-store/"><img src={appstore} alt="Google Play icon"/>App Store</a>
            </div>
        </div>
    </div>
  )
